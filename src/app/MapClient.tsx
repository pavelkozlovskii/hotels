...
const HOTELS = [
  { id: 1, name: "Отель Северный", address: "ул. Ленина, 1", price: 3200, lat: 55.7522, lng: 37.6156 },
  { id: 2, name: "Гранд Отель", address: "пр. Мира, 10", price: 4500, lat: 55.7601, lng: 37.6189 },
  { id: 3, name: "Отель Центр", address: "ул. Пушкина, 5", price: 2800, lat: 55.7558, lng: 37.6173 },
  { id: 4, name: "Отель Восток", address: "ул. Восточная, 3", price: 3900, lat: 55.7517, lng: 37.6200 },
  { id: 5, name: "Отель Южный", address: "ул. Южная, 7", price: 3100, lat: 55.7489, lng: 37.6100 },
];
